...
//Build a Bear
function buildABear(name, age, fur, clothes, specialPower) { // creating a function that takes the parameters: name, age, fur, clothes, specialPower
  var greeting = `Hey partner! My name is ${name} - will you be my friend?!`; // variable greeting as String, uses interpolation to combine parameter name
  var demographics = [name, age]; // variable demographics holds an array with arguments name, age
  var powerSaying = "Did you know that I can " + specialPower + " ?"; // variable powerSaying as String, uses concatenation to combine parameter specialPower
  var builtBear = { // var builtBear is an object literal that holds dynamic variables regarding a completed bear
    basicInfo: demographics, // key: basicInfo, value: referencing a previously defined variable holding an array that takes a parameter of the function
    clothes: clothes, // key: clothes, value: takes the parameter clothes
    exterior: fur, // key: exterior, value: takes the parameter fur
...
// calling the function BuildABear, taking new arguments for the parameters in the function
/* => buildABear {
      basicInfo: ["Fluffy", 4],
...
//FizzBuzz
function fizzBuzz(num1, num2, range) { // function fizzBuzz that takes the parameters num1, num2, range
